...
<div class="row">
						...
						<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">				
							...
							<div class="content">
								...
								<div class="form-group">
									...
									<img src="index.php?route=information/contact/captcha" alt="captcha" class="img-responsive img-captcha" />
								</div>
 ...
 {latLng:[lat, lon], data:"28, Venkatakrishna Road , RA Puram, Chennai,Tamil Nadu"},
	                            ],
	                            options:{
	                                draggable: false
	                            },
