...
window.location.href ="<?php echo CurrentHost; ?>/index.php?route=product/search&search=" + sval + "&category_id=" +searches;
}
...
<script type="application/ld+json">
{
 "@context": "http://schema.org/",
  ...
  "potentialAction": {
    "@type": "SearchAction",
     "target":"<?php echo CurrentHost; ?>/search?term={search_term_string}",
					...
					<div class="show-desktop ">
						<div class="quick-access pull-left">
							<ul class="links">								
								...
								<li><a href="<?php echo CurrentHost; ?>/Footlounge-Frequently-Asked-Questions" id="help" data-toggle="tooltip" title="FAQ" data-placement="bottom"><i class="fa fa-info-circle"></i><?php echo $text_help; ?></a></li>
...
<div class="logo1 inner1">  
					...
					<div class="toppart">
						...
						<div class="toppartright">
							...
							<div class="socialicons">
								...
								<div class="social-icon1"><a target="_blank" href="https://in.pinterest.com/footloungeindia/"><img alt="FootLounge Pinterest" src="<?php echo CurrentHost; ?>/image/social-icons/pinterest_27.png"></a></div>

								<div class="social-icon1"><a target="_blank" href="https://plus.google.com/115256944391879546136/posts"><img src="<?php echo CurrentHost; ?>/image/social-icons/google_plus27.png" alt="FootLounge Google+"></a></div>

								<div class="social-icon1"><a target="_blank" href="https://www.youtube.com/c/adidas"><img src="<?php echo CurrentHost; ?>/image/social-icons/youtube-iconsmall.png" alt="FootLounge YouTube"></a></div>  
								
								<div class="social-icon1"><a target="_blank" href="https://www.instagram.com/go_footlounge"><img src="<?php echo CurrentHost; ?>/image/social-icons/instagramsmall.png" alt="FootLounge Instagram"></a></div>
								 
								<div class="social-icon1"><a target="_blank" href="https://twitter.com/go_footlounge"><img src="<?php echo CurrentHost; ?>/image/social-icons/twittersmall1.png" alt="FootLounge Twitter"></a></div>	
					...
					<div class="bottompart">
						...
						<div class="cart-mini-right">
							<!--<div class="socialicons">
								<div class="social-icon1"><img src="<?php echo CurrentHost; ?>/image/social-icons/twitter.png" style=" height:40px; width:40px;" alt="FootLounge Twitter"></div> 
								<div class="social-icon1"><img src="<?php echo CurrentHost; ?>/image/social-icons/instagramsmall.png" style=" height:40px; width:40px;" alt="FootLounge Instagram"></div>
								<div class="social-icon1"><img src="<?php echo CurrentHost; ?>/image/social-icons/you-tube-icon.png" style=" height:40px; width:40px;" alt="FootLounge YouTube"></div>
