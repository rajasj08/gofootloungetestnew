...
<section id="content404" class="content404">
    ...
    <div tabindex="501" class="screenreader">
       <img src="<?php echo CurrentHost; ?>/catalog/view/theme/lexus_nextstore/image/page404/teamflcartoonshoes.png" class="new_page_imgwid" alt="Page 404">
							...
							<div class="inner">
								<ul>
									...
									<!---<li class="col-lg-12 col-sm-12 col-xs-12">
										<a href="<?php echo CurrentHost; ?>/running-shoes">Top Brands</a>
										...
										<ul> -->
											...
											<li class="col-lg-3 col-sm-3 col-xs-12 first liststyle">
												<a href="<?php echo CurrentHost; ?>/men">Men</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="<?php echo CurrentHost; ?>/women">Women</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="<?php echo CurrentHost; ?>/kids">Kids</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="<?php echo CurrentHost; ?>/fitness">Fitness</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="<?php echo CurrentHost; ?>/apparel">Apparel</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="<?php echo CurrentHost; ?>/flip-flops">Flip Flops</a>
																							
											</li>

											<li class="col-lg-3 col-sm-3 col-xs-12 liststyle">
												<a href="<?php echo CurrentHost; ?>/lifestyle-sandals">LifeStyle Sandals</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="<?php echo CurrentHost; ?>/luggage-bags">Luggage Bags</a>
																							
											</li>
											<li class="col-lg-3 col-sm-3 col-xs-12 last liststyle">
												<a href="<?php echo CurrentHost; ?>/running-shoes">Running Shoes</a>
		...
		<div class="row brandrow">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
							<div class="inner">
								...
								<!---	<li class="col-lg-12 col-sm-12 col-xs-12">
										<a href="<?php echo CurrentHost; ?>/running-shoes">Information</a>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <span id="loadingspan" class="new_page_disp1"><img src="<?php echo CurrentHost; ?>/catalog/view/theme/lexus_nextstore/image/fb-loading.gif" alt="Loading"> </span>  
