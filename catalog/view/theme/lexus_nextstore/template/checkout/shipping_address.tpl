<?php if ($addresses) { ?>
	...
	<div id="shipping-existing">
		<select name="address_id" class="new_payment_width" size="5">
...
<div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
	<table class="form">
		...
		<tr>
			<td><input type="text" name="postcode" value="" class="large-field" onchange="getchangedvalues1();"/></td>
		</tr>  
...
<div class="buttons">
	<div class="right">
		<input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" class="button btn btn-theme-default" />
	</div>
</div>
