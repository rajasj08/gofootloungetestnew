...
<?php } ?>
<div class="new_klarna_mb"><img src="https://cdn.klarna.com/public/images/<?php echo $iso_code_2; ?>/badges/v1/invoice/<?php echo $iso_code_2; ?>_invoice_badge_std_blue.png?width=150&eid=<?php echo $merchant ?>" alt="klarna"/></div>
<div id="payment">
