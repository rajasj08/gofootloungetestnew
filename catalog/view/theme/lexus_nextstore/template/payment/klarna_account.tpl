...
<?php } ?>
<div class="new_klarna_mb"><img src="https://cdn.klarna.com/public/images/<?php echo $iso_code_2; ?>/badges/v1/account/<?php echo $iso_code_2; ?>_account_badge_std_blue.png?width=150&eid=<?php echo $merchant; ?>" alt="klarna" /></div>
<div id="payment">
  <div class="new_klarna_mb1"><b><?php echo $text_payment_option; ?></b></div>
  <div class="content">
    <table class="radio">
      ...
      <tr class="highlight">
        ...
        <td class="new_klarna_cnewsty"><?php if ($iso_code_3 == 'NLD') { ?>
  ...
  <div class="new_klarna_mb1"><b><?php echo $text_additional; ?></b></div>
  <div class="content">
    <table class="form">
      <?php if (!$company) { ?>
...
$('#button-confirm').on('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#payment').before('<div class="attention"><img src="catalog/view/theme/default/image/loading.gif" alt="loading" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
