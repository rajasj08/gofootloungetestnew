				...
				<div class="row">
					<div class="content col-sm-6">
						...
						<table class="form">
							...
							<tr>
								<td> <!--<span class="required">*</span>--> <?php echo $entry_homephone; ?> </td> 
							</tr>
							<tr>
								<td>
...
<tr>
					...
					<div class="content col-sm-6">
						...
						<table class="form">
							...
							<tr id="company-id-display" class="new_register_tr">
								<td>
							...
							<tr id="tax-id-display" class="new_register_tr">
								<td>
...
<?php echo $footer; ?>
<!--validation for home phone and mobile phone number---->
<script>
