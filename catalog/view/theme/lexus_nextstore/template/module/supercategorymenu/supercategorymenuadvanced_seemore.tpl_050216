...
<div id="search_container_<?php echo $i; ?>" >
  <ul>
    ...
    <?php }else{ 
     ...
     ?>
    <li><em>&nbsp;</em><a class="smenu {dnd:'<?php echo $value['href'];?>', ajaxurl:'<?php echo $value['ajax_url'];?>', gapush:'<?php echo $gap; ?>'}" href="javascript:void(0)" <?php echo $nofollow; ?>><?php echo $value_no_sel['tipo']=="product_info" ? $value['val_formatted']: $value['name'];?></a><?php echo $count; ?></li>
    <?php } ?>
...
<?php if($value['seleccionado']== "is_seleccionado") {?>
  ...
  <a class="link_filter_del smenu {dnd:'<?php echo $value['href'];?>', ajaxurl:'<?php echo $value['ajax_url'];?>', gapush:'<?php echo $gap; ?>'}" href="javascript:void(0)" <?php echo $nofollow; ?> > <img src="image/supermenu/spacer.gif" alt="<?php echo $remove_filter_text; ?>" class="filter_del" /></a> <span><?php echo $count; ?></span></li>
 <?php }else{ ?>
  <li><a class="smenu {dnd:'<?php echo $value['href'];?>', ajaxurl:'<?php echo $value['ajax_url'];?>', gapush:'<?php echo $gap; ?>'}" href="javascript:void(0)" <?php echo $nofollow; ?>><img class="picker" align="absmiddle" src="catalog/view/theme/default/image/stars-<?php echo $value['name']; ?>.png"  original-title="<?php echo  sprintf($re_extra_text,$value['name']); ?>" alt="<?php echo  sprintf($re_extra_text,$value['name']); ?>" /></a><span><?php echo $count; ?></span></li>
  <?php } ?>
  <?php } //end is_seleccionado ?>
</ul>
