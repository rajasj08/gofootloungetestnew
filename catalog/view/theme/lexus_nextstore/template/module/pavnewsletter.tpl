...
{
$('#inputNew1').before("<div class=\"success_inline alert alert-success\">Subscribes Successfully...</div>");
			$('#inputNew1').focus();
	
//alert('Subscribes Successfully...')
}
		...
		$.ajax({
			...
			dataType: "application/json",processData: true,
