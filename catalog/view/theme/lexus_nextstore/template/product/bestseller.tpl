...
<?php if( $SPAN_BESTSELLERS[0] ): ?>
	<aside class="col-md-<?php echo $SPAN_BESTSELLERS[0];?>">
...
<section class="col-md-<?php echo $SPAN_BESTSELLERS[1];?> <?php echo $class_3cols;?> ">	
	<div id="content" class="best-sellers">
		...
		<?php if ($products) { ?>
			<?php require( DIR_TEMPLATE.$this->config->get('config_template')."/template/product/product_collection_bestsellers.tpl" );  ?>		
		<?php } ?>
...
<?php if( $SPAN_BESTSELLERS[2] ): ?>
	<aside class="col-md-<?php echo $SPAN_BESTSELLERS[2];?>">	
