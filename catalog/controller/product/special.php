...
class ControllerProductSpecial extends Controller { 	
	public function index() { 
		...
		$this->data['sorts'][] = array(
			...
			'value' => 'p.special-ASC',
			'href'  => $this->url->link('product/special', 'sort=p.special&order=ASC' . $url)
		);

		$this->data['sorts'][] = array(
			'text'  => $this->language->get('text_special_desc'),
			'value' => 'p.special-DESC',
			'href'  => $this->url->link('product/special', 'sort=p.special&order=DESC' . $url)
		);
		...
		$pagination->total = $product_total_val;
