...
class ControllerCommonHome extends Controller {
	...
	public function pageredirect() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/pageredirect.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/common/pageredirect.tpl';
		} else {
			$this->template = 'default/template/common/home.tpl'; 
		} 
