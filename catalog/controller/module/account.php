...
class ControllerModuleAccount extends Controller {
	protected function index() {
		...
		$this->data['text_editorder'] = $this->language->get('text_editorder');
		...
		$this->data['editorder'] = $this->url->link('account/order/editorder', '', 'SSL'); 
		$this->data['sendsms'] = $this->url->link('account/order/sendusersms', '', 'SSL'); 
