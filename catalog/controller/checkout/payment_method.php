...
class ControllerCheckoutPaymentMethod extends Controller {
	...
	public function validate() {
       ...
       public function updateabandoncustomer1()
        {
$this->load->model('checkout/order');
           if(isset($this->session->data['abduserid'])){
            if(isset($this->request->post['step3'])){ 
           
            $resultsdata = $this->model_checkout_order->updateabdandoneduser1('step3',$this->session->data['abduserid'],$this->customer->isLogged());
           ...
           echo  $resultsdata ; 
             ...
             else if(isset($this->request->post['step4']))
              {
