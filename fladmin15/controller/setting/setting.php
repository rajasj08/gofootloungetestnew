...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_deal_title'] = $this->language->get('entry_deal_title');
		$this->data['entry_new_title'] = $this->language->get('entry_new_title');
		$this->data['entry_deal_meta_keyword'] = $this->language->get('entry_deal_meta_keyword');
		$this->data['entry_deal_meta_description'] = $this->language->get('entry_deal_meta_description');
		$this->data['entry_new_meta_keyword'] = $this->language->get('entry_new_meta_keyword');
		$this->data['entry_new_meta_description'] = $this->language->get('entry_new_meta_description');
		...
		if (isset($this->error['desc'])) {
			$this->data['error_desc'] = $this->error['desc'];
		} else {
		...
		/*if (isset($this->request->post['config_desc'])) {
			$this->data['config_desc'] = $this->request->post['config_desc'];
		} else {
			$this->data['config_desc'] = $this->config->get('config_desc');
		} */ 
		...
		if (isset($this->request->post['deal_title'])) {
			$this->data['deal_title'] = $this->request->post['deal_title'];
		} else {
			$this->data['deal_title'] =$this->config->get('deal_title');
		}

		if (isset($this->request->post['new_title'])) {
			$this->data['new_title'] = $this->request->post['new_title'];
		} else {
			$this->data['new_title'] =$this->config->get('new_title');
		}

		if (isset($this->request->post['deal_meta_keyword'])) {
			$this->data['deal_meta_keyword'] = $this->request->post['deal_meta_keyword'];
		} else {
			$this->data['deal_meta_keyword'] =$this->config->get('deal_meta_keyword');
		}

		if (isset($this->request->post['deal_meta_description'])) {
			$this->data['deal_meta_description'] = $this->request->post['deal_meta_description'];
		} else {
			$this->data['deal_meta_description'] = $this->config->get('deal_meta_description');
		}
		if (isset($this->request->post['new_meta_keyword'])) {
			$this->data['new_meta_keyword'] = $this->request->post['new_meta_keyword'];
		} else {
			$this->data['new_meta_keyword'] = $this->config->get('new_meta_keyword');
		}
		if (isset($this->request->post['new_meta_description'])) {
			$this->data['new_meta_description'] = $this->request->post['new_meta_description'];
		} else {
			$this->data['new_meta_description'] = $this->config->get('new_meta_description');
		}
	...
	protected function validate() {
    	...
    	/*if ((utf8_strlen($this->request->post['config_desc']) == ''))  {
