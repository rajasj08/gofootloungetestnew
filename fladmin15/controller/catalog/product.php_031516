...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	protected function getForm() {
		...
		$this->data['entry_lounge_guide'] = $this->language->get('entry_lounge_guide');

	    $this->data['entry_faq'] = $this->language->get('entry_faq');

		$this->data['entry_prod_highlight'] = $this->language->get('entry_prod_highlight');
		...
		if (isset($this->error['lounge_guide'])) {
			$this->data['error_lounge_guide'] = $this->error['lounge_guide'];
		} else {
			$this->data['error_lounge_guide'] = array();
		}	


if (isset($this->error['faq_guide'])) {
			$this->data['error_faq_guide'] = $this->error['faq_guide'];
		} else {
			$this->data['error_faq_guide'] = array();
		}	


		if (isset($this->error['prod_highlight'])) {
			$this->data['error_prod_highlight'] = $this->error['prod_highlight'];
		} else {
			$this->data['error_prod_highlight'] = array();
		}	
