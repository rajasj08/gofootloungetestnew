        ...
        <div id="tab-total" class="vtabs-content">
          <table class="list">
            ...
            <tbody id="total">
              ...
              <?php } ?>
              <?php $coupon_tot=0; foreach ($order_totals as $order_total) { 
            ...
            <tbody>
              ...
              <tr>
               ...
               <tr id="trackorderrow">
                ...
                <td class="left"><select name="order_track" id="order_track" style="text-transform:uppercase;">
                 <?php   $courier_company=["dtdc","fedex","trackcourier","aramex"];  
                         foreach($courier_company as $cc) {
                         if(isset($smsresults)){ if($smsresults[0]['courier_company'] == $cc){
              ...
              <tr id="waybillrow">
                ...
                <td class="left"><input type="text" id="waybillno" name="waybillno" value="<?php if($smsresults) { echo $smsresults[0]['way_bill_no']; } ?>" /><span id="waybillno_err"></span></td>
              </tr> 
  <tr>
