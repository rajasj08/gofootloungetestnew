        ...
        <table class="form">
          ...
          <tr>
            ...
            <td>
            	...
            	<a onclick="upload();" class="button"><span><?php echo $button_import; ?></span></a>
            </td>
          </tr>
         ...
         <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="formcsv">
        <table class="form">
          <tr>
            <td colspan="2"><?php echo 'Product Options Upload'; ?></td>
          </tr>
          
          <tr>
            <td width="25%"><?php echo $entry_restore; ?></td>
            <td>
            	<input type="file" name="sizeupload" id="sizeupload" />
            	<a onclick="sizeupload();" class="button"><span><?php echo $button_import; ?></span></a>

<a onclick="location='<?php echo $sizeexport; ?>'" class="button"><span><?php echo $button_export; ?></span></a>
...
function checkFileSize(id) {
	...
	if (!input ) {
		...
		if (file_size > post_max_size && file_size1 > post_max_size) {
		...
		if (file_size > upload_max_filesize && file_size1 > upload_max_filesize) {
