      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <?php foreach ($languages as $language) { 
            ...
            /*print_r('<pre>');
            print_r($category_description); echo 'sdfddfdsf';

            print_r('<pre>');
            print_r($category_description[$language['language_id']]); echo 'sdfdsf';*/
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                <td><?php echo $entry_filterprice_range; ?></td>
                <td><input type="text" name="category_description[<?php echo $language['language_id']; ?>][price_range_filter]" size="100" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['price_range_filter'] : ''; ?>" /><br/><br/>
                <label>( <b>User Input:</b>&nbsp;<span>0,1000,2500,5000</span>&nbsp; &nbsp; <b>Output:</b><span>&nbsp;<999, 1000-2499, 2500 - 4999, >5000 )</span></label>
                </td>
              </tr>
