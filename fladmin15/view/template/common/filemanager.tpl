...
.filter {
    background: url("view/image/filemanager/filter.png") no-repeat scroll right center rgba(0, 0, 0, 0);
    border: 1px solid #DDDDDD;
    float: right;
    width: 171px;  margin: 3px 0 0;cursor:pointer;
}
...
.filter > input {
    ...
    border-width: medium 1px medium medium; height: 20px;
	width:142px;
}
</style>
</head>
