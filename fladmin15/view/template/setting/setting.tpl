      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <!---  <tr>
              ...
              <td><textarea name="config_desc" cols="40" rows="5"><?php //echo $config_desc; ?></textarea>
                <?php //if ($error_desc) { ?>
        ...
        <div id="tab-store">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_deal_title; ?></td>
              <td><input type="text" name="deal_title" value="<?php echo $deal_title; ?>" />
               </td>
            </tr>

            <tr>
              <td><?php echo $entry_deal_meta_keyword; ?></td>
              <td><input type="text" name="deal_meta_keyword" value="<?php echo $deal_meta_keyword; ?>" />
               </td>
            </tr>
             <tr>
              <td><?php echo $entry_deal_meta_description; ?></td> 
              <td><textarea name="deal_meta_description" cols="40" rows="5"><?php echo $deal_meta_description; ?></textarea></td>
            </tr>
            <tr>
              <td><?php echo $entry_new_title; ?></td>
              <td><input type="text" name="new_title" value="<?php echo $new_title; ?>" />
               </td>
            </tr>
            <tr>
              <td><?php echo $entry_new_meta_keyword; ?></td>
              <td><input type="text" name="new_meta_keyword" value="<?php echo $new_meta_keyword; ?>" />
               </td>
            </tr>
             <tr>
              <td><?php echo $entry_new_meta_description; ?></td> 
              <td><textarea name="new_meta_description" cols="40" rows="5"><?php echo $new_meta_description; ?></textarea></td>
            </tr>
