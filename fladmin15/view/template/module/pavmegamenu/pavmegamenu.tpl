    ...
    <div class="content">
    	 ...
    	 <div id="tab-contents">
	 		...
	 		<div id="tab-manage-menus">				
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
					...
					<div class="megamenu">
						<div class="tree-megamenu">
							...
							<input type="button"class="btn button btn-updatetree" name="serialize" id="serialize" value="Update Orders" />	
							<?php echo $tree; ?>
							<input type="button"class="btn button btn-updatetree" name="serialize" id="serialize" value="Update Orders" />
      		...
      		<!--<div style="font-size:10px;color:#666"><p>Mega Menu is free to use. it's released under GPL/V2. Powered By <a href="http://www.pavothemes.com">PavoThemes.Com</a></div>-->
    </div>
  </div>
</div>
