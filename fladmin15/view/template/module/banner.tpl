          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="banner_module[<?php echo $module_row; ?>][position]">
                  ...
                  <?php } ?>
                  <?php if ($module['position'] == 'offer_slideshow') { ?>
                  <option value="offer_slideshow" selected="selected"><?php echo $text_offer_slideshow; ?></option>
                  <?php } else { ?>
                  <option value="offer_slideshow"><?php echo $text_offer_slideshow; ?></option>
                  <?php } ?>
                </select></td>
...
function addModule() {	
  ...
  html += '      <option value="offer_slideshow"><?php echo $text_offer_slideshow; ?></option>';
