...
$search_analytics_version = '1.1';

if ($_GET['route'] == 'extension/module'){
	$_['heading_title']    = '<span style="position:relative; padding-left:26px;font-weight:bold;"><img style="width:20px; position:absolute; bottom:-3px; left:-1px;" src="view/image/src_ analytics_ logo.gif" />Search Analytics '.$search_analytics_version .'</span>';
}
else {
	$_['heading_title']    = 'Search Analytics '.$search_analytics_version;
}
...
$_['text_success']					= 'Success: You have modified module search analytics!';
...
// Error
$_['error_permission']				= 'Warning: You do not have permission to modify the module Search Analytics!';
?>