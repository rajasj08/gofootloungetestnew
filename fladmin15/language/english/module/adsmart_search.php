...
$adsmart_src_version = '3.2.0';

if ($_GET['route'] == 'extension/module'){
...
$_['text_enable_module']	= 'Enable Advanced Smart Search';
...
$_['text_mysql_var_name']	= 'Variable name';	
...
$_['text_help_partial_words']		= 'This option extends matches to partial words. For example, the word <b><i>shelf</i></b> will also match compund words like <b>book<i class="match">shelf</i></b>. Partial word searches are performed by the two search algorithms <b>Defalut</b> and <b>Fast</b> in two slightly different ways. <a href="#partial-words">Click here to learn more</a>.';
...
$_['success_uninstall']		= '<b>Advanced Smart Search</b> uninstalled successfully.';
$_['error_install']			= 'Warning: Unable to install <b>Advanced Smart Search</b>. XML missing?';
$_['error_uninstall']		= 'Warning: An error occurred while uninstalling <b>Advanced Smart Search</b>. XML missing?';
$_['text_save_success']		= 'The extension <b>Advanced Smart Search</b> has been saved successfully';
$_['text_error']			= 'Error';
