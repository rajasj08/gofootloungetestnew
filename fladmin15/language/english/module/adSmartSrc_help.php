	...
	<div class="content">
		...
		<div class="general-src-optn">
			...
			<div class="match-type">
				...
				<p>When both the options <b>Exact match</b> and <b><a href="#misspellings">Misspellings</a></b> are enabled, misspelled words will not be detected.</p>
			...
			<div class="partial-words">
				...
				<p>Enable this option if your product main keywords are compund words (words made up of two or more words, like, <b><i><span class="match">book</span>let</i></b>, <b><i>bread<span class="match">knife</span></i></b>) and where single words (<b><i><span class="match">book</span></i></b>, <b><i><span class="match">knife</span></i></b>) might be used for searches in place of the main keywords.</p>				
				...
				<p>If you have products whose main keywords are compound words, rather than enabling the partial word matching, optimize product field contents. For example, if the main product keyword is <i>'bookshelf'</i>, enable fields like <b>meta description</b>, <b>meta keywords</b> or <b>tags</b> and add the words <i>'book'</i> and <i>'shelf'</i> in their contents. It will also help your product page to rank better on external search engines like Google.</p>
