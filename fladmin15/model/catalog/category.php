...
class ModelCatalogCategory extends Model {
	...
	public function editCategory($category_id, $data) {
		...
		foreach ($data['category_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "category_description SET category_id = '" . (int)$category_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', description = '" . $this->db->escape($value['description']) . "', price_range_filter = '" . $this->db->escape($value['price_range_filter']) . "'");
		}
	...
	public function getCategoryDescriptions($category_id) {
		...
		foreach ($query->rows as $result) {
			$category_description_data[$result['language_id']] = array(
				...
				'price_range_filter' =>$result['price_range_filter']
			);
		}
